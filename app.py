...
TIMETABLE = {
    "zenkojishita": {
        ...
        "down": [
            {"time": "06:45", "destination": "Yudanaka", "type": "local"},
            {"time": "07:50", "destination": "Yudanaka", "type": "express"},
            {"time": "09:20", "destination": "Yudanaka", "type": "local"},
            {"time": "11:30", "destination": "Yudanaka", "type": "local"},
            {"time": "14:00", "destination": "Yudanaka", "type": "express"},
        ],
    }
}
